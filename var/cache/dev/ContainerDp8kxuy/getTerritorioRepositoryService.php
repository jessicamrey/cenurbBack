...
// Returns the private 'App\Repository\TerritorioRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TerritorioRepository.php';

return $this->services['App\\Repository\\TerritorioRepository'] = new \App\Repository\TerritorioRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
