...
// Returns the private 'App\Repository\TempUserRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TempUserRepository.php';

return $this->services['App\\Repository\\TempUserRepository'] = new \App\Repository\TempUserRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
