...
// Returns the private 'App\Repository\LocNidosColRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LocNidosColRepository.php';

return $this->services['App\\Repository\\LocNidosColRepository'] = new \App\Repository\LocNidosColRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
