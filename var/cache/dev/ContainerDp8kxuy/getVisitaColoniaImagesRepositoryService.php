...
// Returns the private 'App\Repository\VisitaColoniaImagesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VisitaColoniaImagesRepository.php';

return $this->services['App\\Repository\\VisitaColoniaImagesRepository'] = new \App\Repository\VisitaColoniaImagesRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
