...
return $this->privates['App\\Repository\\VisitaTerritorioImagesRepository'] = new \App\Repository\VisitaTerritorioImagesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
