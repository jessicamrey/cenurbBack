...
return $this->privates['App\\Repository\\VisitasTerritorioRepository'] = new \App\Repository\VisitasTerritorioRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
