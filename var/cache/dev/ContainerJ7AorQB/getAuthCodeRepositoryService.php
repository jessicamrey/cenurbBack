...
// Returns the private 'App\Repository\AuthCodeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AuthCodeRepository.php';

return $this->privates['App\\Repository\\AuthCodeRepository'] = new \App\Repository\AuthCodeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
