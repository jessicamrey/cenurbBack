...
$b->setEntityNamespaces(array('Seo' => 'App\\Entity'));
$b->setMetadataCacheImpl(${($_ = isset($this->services['doctrine_cache.providers.doctrine.orm.seo_metadata_cache']) ? $this->services['doctrine_cache.providers.doctrine.orm.seo_metadata_cache'] : $this->load('getDoctrineCache_Providers_Doctrine_Orm_SeoMetadataCacheService.php')) && false ?: '_'});
$b->setQueryCacheImpl(${($_ = isset($this->services['doctrine_cache.providers.doctrine.orm.seo_query_cache']) ? $this->services['doctrine_cache.providers.doctrine.orm.seo_query_cache'] : $this->load('getDoctrineCache_Providers_Doctrine_Orm_SeoQueryCacheService.php')) && false ?: '_'});
$b->setResultCacheImpl(${($_ = isset($this->services['doctrine_cache.providers.doctrine.orm.seo_result_cache']) ? $this->services['doctrine_cache.providers.doctrine.orm.seo_result_cache'] : $this->load('getDoctrineCache_Providers_Doctrine_Orm_SeoResultCacheService.php')) && false ?: '_'});
...
$b->setEntityListenerResolver(${($_ = isset($this->services['doctrine.orm.seo_entity_listener_resolver']) ? $this->services['doctrine.orm.seo_entity_listener_resolver'] : $this->services['doctrine.orm.seo_entity_listener_resolver'] = new \Doctrine\Bundle\DoctrineBundle\Mapping\ContainerAwareEntityListenerResolver($this)) && false ?: '_'});
...
$this->services['doctrine.orm.seo_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create(${($_ = isset($this->services['doctrine.dbal.seo_connection']) ? $this->services['doctrine.dbal.seo_connection'] : $this->load('getDoctrine_Dbal_SeoConnectionService.php')) && false ?: '_'}, $b);

${($_ = isset($this->services['doctrine.orm.seo_manager_configurator']) ? $this->services['doctrine.orm.seo_manager_configurator'] : $this->services['doctrine.orm.seo_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array())) && false ?: '_'}->configure($instance);
