...
return $this->privates['App\\Repository\\ObservacionesTerritorioRepository'] = new \App\Repository\ObservacionesTerritorioRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
