...
return $this->privates['App\\Repository\\VisitaColoniaImagesRepository'] = new \App\Repository\VisitaColoniaImagesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
