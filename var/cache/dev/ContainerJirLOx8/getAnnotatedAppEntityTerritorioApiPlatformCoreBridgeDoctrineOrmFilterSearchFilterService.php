...
return $this->privates['annotated_app_entity_territorio_api_platform_core_bridge_doctrine_orm_filter_search_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\SearchFilter(($this->services['doctrine'] ?? $this->getDoctrineService()), NULL, ($this->privates['api_platform.iri_converter'] ?? $this->getApiPlatform_IriConverterService()), ($this->services['easy_admin.property_accessor'] ?? $this->getEasyAdmin_PropertyAccessorService()), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ['usuario' => 'exact', 'id' => 'exact', 'codTerritorio' => 'exact', 'nombre' => 'partial', 'barrio' => 'partial', 'calleNumPiso' => 'partial', 'nombreCentro' => 'partial', 'tipoPropiedad' => 'exact', 'tipoEdificio' => 'exact', 'ccaa' => 'exact', 'provincia' => 'exact', 'municipio' => 'exact']);
