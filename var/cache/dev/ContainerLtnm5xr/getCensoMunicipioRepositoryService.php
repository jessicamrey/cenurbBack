...
// Returns the private 'App\Repository\CensoMunicipioRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CensoMunicipioRepository.php';

return $this->services['App\\Repository\\CensoMunicipioRepository'] = new \App\Repository\CensoMunicipioRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
