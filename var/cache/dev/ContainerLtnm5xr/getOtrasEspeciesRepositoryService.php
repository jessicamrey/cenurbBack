...
// Returns the private 'App\Repository\OtrasEspeciesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/OtrasEspeciesRepository.php';

return $this->services['App\\Repository\\OtrasEspeciesRepository'] = new \App\Repository\OtrasEspeciesRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
