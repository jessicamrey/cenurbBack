...
return $this->services['App\\Repository\\EmplazamientoRepository'] = new \App\Repository\EmplazamientoRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
