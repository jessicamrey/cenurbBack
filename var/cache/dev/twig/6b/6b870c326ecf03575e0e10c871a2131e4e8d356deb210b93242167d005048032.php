...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "WebProfilerBundle:Collector:validator.html.twig", "/home/jessica/Escritorio/baack/cenurbBack/vendor/symfony/web-profiler-bundle/Resources/views/Collector/validator.html.twig");
    }
}
