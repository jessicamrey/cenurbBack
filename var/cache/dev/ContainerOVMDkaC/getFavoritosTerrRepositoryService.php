...
// Returns the private 'App\Repository\FavoritosTerrRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FavoritosTerrRepository.php';

return $this->privates['App\\Repository\\FavoritosTerrRepository'] = new \App\Repository\FavoritosTerrRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
