...
return $this->services['vich_uploader.namer_directory_property'] = new \Vich\UploaderBundle\Naming\PropertyDirectoryNamer(($this->services['easy_admin.property_accessor'] ?? $this->getEasyAdmin_PropertyAccessorService()));
