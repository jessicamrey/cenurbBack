...
// Returns the private 'App\Repository\TipoTerritorioRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TipoTerritorioRepository.php';

return $this->services['App\Repository\TipoTerritorioRepository'] = new \App\Repository\TipoTerritorioRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
