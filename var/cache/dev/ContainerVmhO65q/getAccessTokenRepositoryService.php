...
// Returns the private 'App\Repository\AccessTokenRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AccessTokenRepository.php';

return $this->privates['App\\Repository\\AccessTokenRepository'] = new \App\Repository\AccessTokenRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
