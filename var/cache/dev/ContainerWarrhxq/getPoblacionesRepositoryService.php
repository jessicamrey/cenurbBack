...
// Returns the private 'App\Repository\PoblacionesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PoblacionesRepository.php';

return $this->services['App\\Repository\\PoblacionesRepository'] = new \App\Repository\PoblacionesRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
