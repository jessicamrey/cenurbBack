...
// Returns the private 'App\Repository\LocNidosNoColRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LocNidosNoColRepository.php';

return $this->services['App\\Repository\\LocNidosNoColRepository'] = new \App\Repository\LocNidosNoColRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
