...
// Returns the private 'App\Repository\TipoEdificioRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TipoEdificioRepository.php';

return $this->services['App\\Repository\\TipoEdificioRepository'] = new \App\Repository\TipoEdificioRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
