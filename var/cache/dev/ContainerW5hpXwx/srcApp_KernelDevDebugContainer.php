...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'doctrine.dbal.seo_connection' => 'getDoctrine_Dbal_SeoConnectionService',
            'doctrine.orm.default_entity_manager' => 'getDoctrine_Orm_DefaultEntityManagerService',
            'doctrine.orm.seo_entity_manager' => 'getDoctrine_Orm_SeoEntityManagerService',
            'doctrine_cache.providers.doctrine.orm.default_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService',
            'doctrine_cache.providers.doctrine.orm.default_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultQueryCacheService',
            'doctrine_cache.providers.doctrine.orm.default_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultResultCacheService',
            'doctrine_cache.providers.doctrine.orm.seo_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_SeoMetadataCacheService',
            'doctrine_cache.providers.doctrine.orm.seo_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_SeoQueryCacheService',
            'doctrine_cache.providers.doctrine.orm.seo_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_SeoResultCacheService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/src/Util/VisitaColoniaImagesNormalizer.php';
            ...
            include_once $this->targetDirs[3].'/src/Util/VisitaTerritorioImagesNormalizer.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('V7ke56jO6L', 0, ($this->targetDirs[0].'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lj+G+Ji0p2', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber(($this->privates['vich_uploader.listener.clean.VisitaColonia'] ?? $this->getVichUploader_Listener_Clean_VisitaColoniaService()));
        $c->addEventSubscriber(($this->privates['vich_uploader.listener.clean.VisitaTerritorio'] ?? $this->getVichUploader_Listener_Clean_VisitaTerritorioService()));
        $c->addEventSubscriber(($this->privates['vich_uploader.listener.remove.VisitaColonia'] ?? $this->getVichUploader_Listener_Remove_VisitaColoniaService()));
        $c->addEventSubscriber(($this->privates['vich_uploader.listener.upload.VisitaColonia'] ?? $this->getVichUploader_Listener_Upload_VisitaColoniaService()));
        $c->addEventSubscriber(($this->privates['vich_uploader.listener.remove.VisitaTerritorio'] ?? $this->getVichUploader_Listener_Remove_VisitaTerritorioService()));
        $c->addEventSubscriber(($this->privates['vich_uploader.listener.upload.VisitaTerritorio'] ?? $this->getVichUploader_Listener_Upload_VisitaTerritorioService()));
    ...
    /**
     * Gets the public 'doctrine.dbal.seo_connection' shared service.
     *
     * @return \Doctrine\DBAL\Connection
     */
    protected function getDoctrine_Dbal_SeoConnectionService()
    {
        $a = new \Doctrine\DBAL\Configuration();
        ...
        $c = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'doctrine.orm.seo_listeners.attach_entity_listeners' => '?',
        ]));
        $c->addEventSubscriber(($this->privates['vich_uploader.listener.clean.VisitaColonia'] ?? $this->getVichUploader_Listener_Clean_VisitaColoniaService()));
        $c->addEventSubscriber(($this->privates['vich_uploader.listener.clean.VisitaTerritorio'] ?? $this->getVichUploader_Listener_Clean_VisitaTerritorioService()));
        $c->addEventSubscriber(($this->privates['vich_uploader.listener.remove.VisitaColonia'] ?? $this->getVichUploader_Listener_Remove_VisitaColoniaService()));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addCustomNumericFunction('mydistance', 'App\\Doctrine\\DistanceFunction');
    ...
    /**
     * Gets the public 'doctrine.orm.seo_entity_manager' shared service.
     *
     * @return \Doctrine\ORM\EntityManager
     */
    protected function getDoctrine_Orm_SeoEntityManagerService($lazyLoad = true)
    {
        $a = new \Doctrine\ORM\Configuration();
        ...
        $a->setMetadataCacheImpl(($this->services['doctrine_cache.providers.doctrine.orm.seo_metadata_cache'] ?? $this->getDoctrineCache_Providers_Doctrine_Orm_SeoMetadataCacheService()));
        $a->setQueryCacheImpl(($this->services['doctrine_cache.providers.doctrine.orm.seo_query_cache'] ?? $this->getDoctrineCache_Providers_Doctrine_Orm_SeoQueryCacheService()));
        $a->setResultCacheImpl(($this->services['doctrine_cache.providers.doctrine.orm.seo_result_cache'] ?? $this->getDoctrineCache_Providers_Doctrine_Orm_SeoResultCacheService()));
        $a->setMetadataDriverImpl($b);
        $a->setProxyDir(($this->targetDirs[0].'/doctrine/orm/Proxies'));
        $a->setProxyNamespace('Proxies');
        $a->setAutoGenerateProxyClasses(true);
        ...
        $this->services['doctrine.orm.seo_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create(($this->services['doctrine.dbal.seo_connection'] ?? $this->getDoctrine_Dbal_SeoConnectionService()), $a);
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_562fa722201d0b76f19036b354b669530411c7341f952fde8f18b7a3d0c53264');
    ...
    /**
     * Gets the public 'doctrine_cache.providers.doctrine.orm.seo_metadata_cache' shared service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_SeoMetadataCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.seo_metadata_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();

        $instance->setNamespace('sf_orm_seo_562fa722201d0b76f19036b354b669530411c7341f952fde8f18b7a3d0c53264');

        return $instance;
    }

    /**
     * Gets the public 'doctrine_cache.providers.doctrine.orm.seo_query_cache' shared service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_SeoQueryCacheService()
    {
    ...
    /**
     * Gets the public 'doctrine_cache.providers.doctrine.orm.seo_result_cache' shared service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_SeoResultCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.seo_result_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    protected function getProfilerService()
    {
        ...
        $e->addLogger('seo', ($this->privates['doctrine.dbal.logger.profiling.seo'] ?? ($this->privates['doctrine.dbal.logger.profiling.seo'] = new \Doctrine\DBAL\Logging\DebugStack())));
    ...
    protected function getSerializerService()
    {
        ...
        $e = ($this->services['easy_admin.property_accessor'] ?? $this->getEasyAdmin_PropertyAccessorService());
        $f = ($this->privates['serializer.mapping.class_metadata_factory'] ?? $this->getSerializer_Mapping_ClassMetadataFactoryService());
        ...
        $i = new \ApiPlatform\Core\Serializer\ItemNormalizer($a, $b, $c, $d, $e, $g, $f, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $h, false);
        $j = ($this->privates['api_platform.router'] ?? $this->getApiPlatform_RouterService());

        $k = new \ApiPlatform\Core\Bridge\Symfony\Routing\OperationMethodResolver($j, $h);
        $l = ($this->privates['api_platform.subresource_operation_factory.cached'] ?? $this->getApiPlatform_SubresourceOperationFactory_CachedService());
        $m = ($this->privates['api_platform.filter_locator'] ?? $this->getApiPlatform_FilterLocatorService());

        $n = new \ApiPlatform\Core\Swagger\Serializer\ApiGatewayNormalizer(new \ApiPlatform\Core\Swagger\Serializer\DocumentationNormalizer($h, $a, $b, $d, $k, new \ApiPlatform\Core\Bridge\Symfony\Routing\RouterOperationPathResolver($j, ($this->privates['api_platform.operation_path_resolver.custom'] ?? $this->getApiPlatform_OperationPathResolver_CustomService()), $l), NULL, $m, $g, false, 'oauth2', 'application', '/oauth/v2/token', '/oauth/v2/auth', [], [], $l, true, 'page', false, 'itemsPerPage', ($this->privates['api_platform.formats_provider'] ?? $this->getApiPlatform_FormatsProviderService()), false, 'pagination'));
        $o = ($this->privates['api_platform.jsonld.context_builder'] ?? $this->getApiPlatform_Jsonld_ContextBuilderService());
        $p = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($f, $g, $e, ($this->privates['property_info'] ?? $this->getPropertyInfoService()), new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($f), NULL, []);

        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \App\Util\VisitaColoniaImagesNormalizer($i, $this->getEnv('APP_IMAGE_VISITACOL'), $this->getEnv('BASE_URL')), 1 => new \App\Util\VisitaTerritorioImagesNormalizer($i, $this->getEnv('APP_IMAGE_VISITATERR'), $this->getEnv('BASE_URL')), 2 => $n, 3 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($j, [], $g), 4 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $g), 5 => $n, 6 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($o, $d, $c), 'page', 'pagination'), $h, $d, $m), 7 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($h, $a, $b, $d, $k, $j, $l, $g), 8 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($h, $c, $j), 9 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($j, true), 10 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 11 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 12 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 13 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $g), 14 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 15 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 16 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($h, $a, $b, $c, $d, $o, $e, $g, $f, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), false), 17 => $i, 18 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($p, $c, $o), 19 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 20 => $p], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder(), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FhbNi3OeDb', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('okHOPeLcPw', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q34NFJqMcs', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WEapiPfKgP', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KJc46mzzHQ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_censo_municipio_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => ['privates', 'annotated_app_entity_censo_municipio_api_platform_core_bridge_doctrine_orm_filter_numeric_filter', 'getAnnotatedAppEntityCensoMunicipioApiPlatformCoreBridgeDoctrineOrmFilterNumericFilterService.php', true],
            'annotated_app_entity_censo_municipio_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_censo_municipio_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityCensoMunicipioApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService.php', true],
            'annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => ['privates', 'annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_boolean_filter', 'getAnnotatedAppEntityColoniaApiPlatformCoreBridgeDoctrineOrmFilterBooleanFilterService.php', true],
            'annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => ['privates', 'annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_numeric_filter', 'getAnnotatedAppEntityColoniaApiPlatformCoreBridgeDoctrineOrmFilterNumericFilterService.php', true],
            'annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_range_filter' => ['privates', 'annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_range_filter', 'getAnnotatedAppEntityColoniaApiPlatformCoreBridgeDoctrineOrmFilterRangeFilterService.php', true],
            'annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityColoniaApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService.php', true],
            'annotated_app_entity_otras_especies_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => ['privates', 'annotated_app_entity_otras_especies_api_platform_core_bridge_doctrine_orm_filter_numeric_filter', 'getAnnotatedAppEntityOtrasEspeciesApiPlatformCoreBridgeDoctrineOrmFilterNumericFilterService.php', true],
            'annotated_app_entity_otras_especies_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_otras_especies_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityOtrasEspeciesApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService.php', true],
            'annotated_app_entity_territorio_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => ['privates', 'annotated_app_entity_territorio_api_platform_core_bridge_doctrine_orm_filter_boolean_filter', 'getAnnotatedAppEntityTerritorioApiPlatformCoreBridgeDoctrineOrmFilterBooleanFilterService.php', true],
            'annotated_app_entity_territorio_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => ['privates', 'annotated_app_entity_territorio_api_platform_core_bridge_doctrine_orm_filter_numeric_filter', 'getAnnotatedAppEntityTerritorioApiPlatformCoreBridgeDoctrineOrmFilterNumericFilterService.php', true],
            'annotated_app_entity_territorio_api_platform_core_bridge_doctrine_orm_filter_range_filter' => ['privates', 'annotated_app_entity_territorio_api_platform_core_bridge_doctrine_orm_filter_range_filter', 'getAnnotatedAppEntityTerritorioApiPlatformCoreBridgeDoctrineOrmFilterRangeFilterService.php', true],
            'annotated_app_entity_territorio_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_territorio_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityTerritorioApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService.php', true],
            'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => ['privates', 'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_boolean_filter', 'getAnnotatedAppEntityVisitasColoniaApiPlatformCoreBridgeDoctrineOrmFilterBooleanFilterService.php', true],
            'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_date_filter' => ['privates', 'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_date_filter', 'getAnnotatedAppEntityVisitasColoniaApiPlatformCoreBridgeDoctrineOrmFilterDateFilterService.php', true],
            'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => ['privates', 'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_numeric_filter', 'getAnnotatedAppEntityVisitasColoniaApiPlatformCoreBridgeDoctrineOrmFilterNumericFilterService.php', true],
            'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityVisitasColoniaApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService.php', true],
            'annotated_app_entity_visitas_territorio_api_platform_core_bridge_doctrine_orm_filter_date_filter' => ['privates', 'annotated_app_entity_visitas_territorio_api_platform_core_bridge_doctrine_orm_filter_date_filter', 'getAnnotatedAppEntityVisitasTerritorioApiPlatformCoreBridgeDoctrineOrmFilterDateFilterService.php', true],
            'annotated_app_entity_visitas_territorio_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => ['privates', 'annotated_app_entity_visitas_territorio_api_platform_core_bridge_doctrine_orm_filter_numeric_filter', 'getAnnotatedAppEntityVisitasTerritorioApiPlatformCoreBridgeDoctrineOrmFilterNumericFilterService.php', true],
            'annotated_app_entity_visitas_territorio_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_visitas_territorio_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityVisitasTerritorioApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService.php', true],
        ], [
            'annotated_app_entity_censo_municipio_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => '?',
            'annotated_app_entity_censo_municipio_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => '?',
            'annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => '?',
            'annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_range_filter' => '?',
            'annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_otras_especies_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => '?',
            ...
            'annotated_app_entity_territorio_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => '?',
            'annotated_app_entity_territorio_api_platform_core_bridge_doctrine_orm_filter_range_filter' => '?',
            'annotated_app_entity_territorio_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => '?',
            'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_date_filter' => '?',
            'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => '?',
            'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_visitas_territorio_api_platform_core_bridge_doctrine_orm_filter_date_filter' => '?',
            'annotated_app_entity_visitas_territorio_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' => '?',
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('S+UYdQIYdi', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('igPpjqdyvK', 0, ($this->targetDirs[0].'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DljXMcGEkX', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Noec5Yscjy', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lizdLU+o-i', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xeE4yXBxQm', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_ContainerRepositoryFactoryService()
    {
        return $this->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\CensoColoniaRepository' => '?',
            'App\\Repository\\CensoMunicipioRepository' => '?',
            'App\\Repository\\ClientRepository' => '?',
            'App\\Repository\\ColoniaRepository' => '?',
            'App\\Repository\\ComunidadesRepository' => '?',
            'App\\Repository\\EmplazamientoRepository' => '?',
            'App\\Repository\\FavoritosColRepository' => '?',
            'App\\Repository\\FavoritosTerrRepository' => '?',
            'App\\Repository\\LocNidosColRepository' => '?',
            'App\\Repository\\LocNidosNoColRepository' => '?',
            'App\\Repository\\ObservacionesTerritorioRepository' => '?',
            'App\\Repository\\OtrasEspeciesRepository' => '?',
            'App\\Repository\\PoblacionesRepository' => '?',
            'App\\Repository\\ProvinciasRepository' => '?',
            'App\\Repository\\RefreshTokenRepository' => '?',
            'App\\Repository\\SegUsuRepository' => '?',
            'App\\Repository\\TempUserRepository' => '?',
            'App\\Repository\\TemporadaRepository' => '?',
            'App\\Repository\\TerritorioRepository' => '?',
            'App\\Repository\\TipoEdificioRepository' => '?',
            'App\\Repository\\TipoPropiedadRepository' => '?',
            'App\\Repository\\TipoTerritorioRepository' => '?',
            'App\\Repository\\VisitaColoniaImagesRepository' => '?',
            'App\\Repository\\VisitaTerritorioImagesRepository' => '?',
            'App\\Repository\\VisitasColoniaRepository' => '?',
            'App\\Repository\\VisitasTerritorioRepository' => '?',
        ]));
    }
    ...
    protected function getPropertyInfoService()
    {
        return $this->privates['property_info'] = new \Symfony\Component\PropertyInfo\PropertyInfoExtractor(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['doctrine.orm.seo_entity_manager.property_info_extractor'] ?? $this->load('getDoctrine_Orm_SeoEntityManager_PropertyInfoExtractorService.php'));
            ...
            yield 1 => ($this->privates['doctrine.orm.seo_entity_manager.property_info_extractor'] ?? $this->load('getDoctrine_Orm_SeoEntityManager_PropertyInfoExtractorService.php'));
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            yield 'security.firewall.map.context.oauth_token' => ($this->privates['.security.request_matcher.HeUdK73'] ?? ($this->privates['.security.request_matcher.HeUdK73'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/login')));
            yield 'security.firewall.map.context.oauth_authorize' => ($this->privates['.security.request_matcher.c1hP0KI'] ?? ($this->privates['.security.request_matcher.c1hP0KI'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/auth')));
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDirs[0].'/translations'), 'debug' => true, 'resource_files' => ['af' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.af.xlf')], 'ar' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.ar.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.ar.yml'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.ar.xlf'), 5 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.ar.xlf')], 'az' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.az.xlf')], 'be' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.be.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.be.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.be.xlf')], 'bg' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.bg.xlf'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.bg.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.bg.xlf')], 'ca' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.ca.xlf'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.ca.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.ca.xlf')], 'cs' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.cs.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.cs.yml'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.cs.xlf'), 5 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.cs.xlf')], 'cy' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.cy.xlf')], 'da' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.da.xlf'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.da.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.da.xlf')], 'de' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.de.yml'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.de.xlf'), 5 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.de.xlf'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/Resources/translations/FOSOAuthServerBundle.de.yml')], 'el' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.el.xlf'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.el.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.el.xlf')], 'en' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.en.yml'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.en.xlf'), 5 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.en.xlf'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/Resources/translations/FOSOAuthServerBundle.en.yml')], 'es' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.es.yml'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.es.xlf'), 5 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.es.xlf')], 'et' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.et.xlf')], 'eu' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.eu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.eu.xlf'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.eu.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.eu.xlf')], 'fa' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.fa.xlf'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.fa.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.fa.xlf')], 'fi' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.fi.xlf'), 2 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.fi.yml'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.fi.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.fi.xlf')], 'fr' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.fr.yml'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.fr.xlf'), 5 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.fr.xlf'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/Resources/translations/FOSOAuthServerBundle.fr.yml')], 'gl' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.gl.xlf'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.gl.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.gl.xlf')], 'he' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.he.xlf')], 'hr' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.hr.xlf'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.hr.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.hr.xlf')], 'hu' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.hu.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.hu.yml'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.hu.xlf'), 5 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.hu.xlf')], 'hy' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.hy.xlf')], 'id' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.id.xlf')], 'it' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.it.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.it.yml'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.it.xlf'), 5 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.it.xlf')], 'ja' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.ja.xlf')], 'lb' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.lb.xlf')], 'lt' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.lt.xlf'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.lt.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.lt.xlf')], 'lv' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.lv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.lv.xlf')], 'mn' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.mn.xlf')], 'nb' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.nb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.nb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.nb.xlf')], 'nl' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.nl.xlf'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.nl.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.nl.xlf')], 'nn' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.nn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.nn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.nn.xlf')], 'no' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.no.xlf')], 'pl' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.pl.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.pl.yml'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.pl.xlf'), 5 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.pl.xlf')], 'pt' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.pt.xlf'), 2 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.pt.yml'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.pt.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.pt.xlf')], 'pt_BR' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.pt_BR.xlf')], 'ro' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.ro.xlf'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.ro.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.ro.xlf')], 'ru' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.ru.yml'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.ru.xlf'), 5 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.ru.xlf')], 'sk' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.sk.xlf')], 'sl' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.sl.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.sl.yml'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.sl.xlf'), 5 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.sl.xlf'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/Resources/translations/FOSOAuthServerBundle.sl.yml')], 'sq' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sq.xlf')], 'sr_Cyrl' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.sr_Cyrl.xlf')], 'sr_Latn' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.sr_Latn.xlf')], 'sv' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.sv.xlf'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.sv.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.sv.xlf')], 'th' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.th.xlf')], 'tl' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.tl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.tl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.tl.xlf')], 'tr' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.tr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.tr.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.tr.yml'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.tr.xlf'), 5 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.tr.xlf')], 'uk' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.uk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.uk.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.uk.yml'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.uk.xlf'), 5 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.uk.xlf')], 'vi' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.vi.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.vi.xlf')], 'zh_CN' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.zh_CN.xlf'), 3 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.zh_CN.xlf'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.zh_CN.xlf')], 'zh_TW' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.zh_TW.xlf')], 'pt_PT' => [0 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations/security.pt_PT.xlf')], 'sr_RS' => [0 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/EasyAdminBundle.sr_RS.xlf'), 1 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations/messages.sr_RS.xlf')]], 'scanned_directories' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations'), 2 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations'), 4 => ($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/translations'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/Resources/translations'), 6 => ($this->targetDirs[3].'/translations'), 7 => ($this->targetDirs[3].'/translations'), 8 => ($this->targetDirs[3].'/vendor/symfony/framework-bundle/Resources/translations'), 9 => ($this->targetDirs[3].'/src/Resources/FrameworkBundle/translations'), 10 => ($this->targetDirs[3].'/vendor/doctrine/doctrine-cache-bundle/Resources/translations'), 11 => ($this->targetDirs[3].'/src/Resources/DoctrineCacheBundle/translations'), 12 => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/translations'), 13 => ($this->targetDirs[3].'/src/Resources/SensioFrameworkExtraBundle/translations'), 14 => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/translations'), 15 => ($this->targetDirs[3].'/src/Resources/DoctrineBundle/translations'), 16 => ($this->targetDirs[3].'/vendor/doctrine/doctrine-migrations-bundle/Resources/translations'), 17 => ($this->targetDirs[3].'/src/Resources/DoctrineMigrationsBundle/translations'), 18 => ($this->targetDirs[3].'/vendor/symfony/security-bundle/Resources/translations'), 19 => ($this->targetDirs[3].'/src/Resources/SecurityBundle/translations'), 20 => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/translations'), 21 => ($this->targetDirs[3].'/src/Resources/SwiftmailerBundle/translations'), 22 => ($this->targetDirs[3].'/vendor/symfony/web-profiler-bundle/Resources/translations'), 23 => ($this->targetDirs[3].'/src/Resources/WebProfilerBundle/translations'), 24 => ($this->targetDirs[3].'/vendor/symfony/twig-bundle/Resources/translations'), 25 => ($this->targetDirs[3].'/src/Resources/TwigBundle/translations'), 26 => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/translations'), 27 => ($this->targetDirs[3].'/src/Resources/MonologBundle/translations'), 28 => ($this->targetDirs[3].'/vendor/symfony/debug-bundle/Resources/translations'), 29 => ($this->targetDirs[3].'/src/Resources/DebugBundle/translations'), 30 => ($this->targetDirs[3].'/vendor/symfony/maker-bundle/src/Resources/translations'), 31 => ($this->targetDirs[3].'/src/Resources/MakerBundle/translations'), 32 => ($this->targetDirs[3].'/vendor/symfony/web-server-bundle/Resources/translations'), 33 => ($this->targetDirs[3].'/src/Resources/WebServerBundle/translations'), 34 => ($this->targetDirs[3].'/vendor/nelmio/cors-bundle/Resources/translations'), 35 => ($this->targetDirs[3].'/src/Resources/NelmioCorsBundle/translations'), 36 => ($this->targetDirs[3].'/vendor/api-platform/core/src/Bridge/Symfony/Bundle/Resources/translations'), 37 => ($this->targetDirs[3].'/src/Resources/ApiPlatformBundle/translations'), 38 => ($this->targetDirs[3].'/src/Resources/VichUploaderBundle/translations'), 39 => ($this->targetDirs[3].'/src/Resources/EasyAdminBundle/translations'), 40 => ($this->targetDirs[3].'/src/Resources/FOSOAuthServerBundle/translations'), 41 => ($this->targetDirs[3].'/src/Resources/translations')]]);
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addLoader(new \Symfony\Bridge\Doctrine\Validator\DoctrineLoader(($this->services['doctrine.orm.seo_entity_manager'] ?? $this->getDoctrine_Orm_SeoEntityManagerService()), NULL));
    ...
    /**
     * Gets the private 'vich_uploader.listener.clean.VisitaColonia' shared service.
     *
     * @return \Vich\UploaderBundle\EventListener\Doctrine\CleanListener
     */
    protected function getVichUploader_Listener_Clean_VisitaColoniaService()
    {
        return $this->privates['vich_uploader.listener.clean.VisitaColonia'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('VisitaColonia', ($this->privates['vich_uploader.adapter.orm'] ?? ($this->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($this->privates['vich_uploader.metadata_reader'] ?? $this->getVichUploader_MetadataReaderService()), ($this->services['vich_uploader.upload_handler'] ?? $this->getVichUploader_UploadHandlerService()));
    }

    /**
     * Gets the private 'vich_uploader.listener.clean.VisitaTerritorio' shared service.
     *
     * @return \Vich\UploaderBundle\EventListener\Doctrine\CleanListener
     */
    protected function getVichUploader_Listener_Clean_VisitaTerritorioService()
    {
    ...
    /**
     * Gets the private 'vich_uploader.listener.remove.VisitaColonia' shared service.
     *
     * @return \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener
     */
    protected function getVichUploader_Listener_Remove_VisitaColoniaService()
    {
        return $this->privates['vich_uploader.listener.remove.VisitaColonia'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('VisitaColonia', ($this->privates['vich_uploader.adapter.orm'] ?? ($this->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($this->privates['vich_uploader.metadata_reader'] ?? $this->getVichUploader_MetadataReaderService()), ($this->services['vich_uploader.upload_handler'] ?? $this->getVichUploader_UploadHandlerService()));
    }

    /**
     * Gets the private 'vich_uploader.listener.remove.VisitaTerritorio' shared service.
     *
     * @return \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener
     */
    protected function getVichUploader_Listener_Remove_VisitaTerritorioService()
    {
    ...
    /**
     * Gets the private 'vich_uploader.listener.upload.VisitaColonia' shared service.
     *
     * @return \Vich\UploaderBundle\EventListener\Doctrine\UploadListener
     */
    protected function getVichUploader_Listener_Upload_VisitaColoniaService()
    {
    ...
    /**
     * Gets the private 'vich_uploader.listener.upload.VisitaTerritorio' shared service.
     *
     * @return \Vich\UploaderBundle\EventListener\Doctrine\UploadListener
     */
    protected function getVichUploader_Listener_Upload_VisitaTerritorioService()
    {
        return $this->privates['vich_uploader.listener.upload.VisitaTerritorio'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('VisitaTerritorio', ($this->privates['vich_uploader.adapter.orm'] ?? ($this->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($this->privates['vich_uploader.metadata_reader'] ?? $this->getVichUploader_MetadataReaderService()), ($this->services['vich_uploader.upload_handler'] ?? $this->getVichUploader_UploadHandlerService()));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'api_platform.resource_class_directories': $value = [
                ...
                2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/Entity'),
            ]; break;
            case 'vich_uploader.mappings': $value = [
                'VisitaColonia' => [
                    'uri_prefix' => $this->getEnv('APP_IMAGE_VISITACOL'),
                    'upload_destination' => ($this->targetDirs[3].'/public/'.$this->getEnv('string:APP_IMAGE_VISITACOL')),
                ...
                'VisitaTerritorio' => [
                    'uri_prefix' => $this->getEnv('APP_IMAGE_VISITATERR'),
                    'upload_destination' => ($this->targetDirs[3].'/public/'.$this->getEnv('string:APP_IMAGE_VISITATERR')),
                    'inject_on_load' => false,
                    'delete_on_update' => true,
                    'delete_on_remove' => true,
                    'namer' => [
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'easyadmin.config' => [
                'entities' => [
                    'Colonia' => [
                        'class' => 'App\\Entity\\Colonia',
                        'name' => 'Colonia',
                    ],
                    'LocNidosCol' => [
                        'class' => 'App\\Entity\\LocNidosCol',
                        'name' => 'LocNidosCol',
                    ],
                    'OtrasEspecies' => [
                        'class' => 'App\\Entity\\OtrasEspecies',
                        'name' => 'OtrasEspecies',
                    ],
                    'VisitasColonia' => [
                        'class' => 'App\\Entity\\VisitasColonia',
                        'name' => 'VisitasColonia',
                    ],
                    'Territorio' => [
                        'class' => 'App\\Entity\\Territorio',
                        'name' => 'Territorio',
                    ],
                    'LocNidosNoCol' => [
                        'class' => 'App\\Entity\\LocNidosNoCol',
                        'name' => 'LocNidosNoCol',
                    ],
                    'VisitasTerritorio' => [
                        'class' => 'App\\Entity\\VisitasTerritorio',
                        'name' => 'VisitasTerritorio',
                    ],
                    'SegUsu' => [
                    ...
                    'CensoMunicipio' => [
                        'class' => 'App\\Entity\\CensoMunicipio',
                        'name' => 'CensoMunicipio',
                    ],
                    'Emplazamiento' => [
                        'class' => 'App\\Entity\\Emplazamiento',
                        'name' => 'Emplazamiento',
                    ],
                    'ObservacionesTerritorio' => [
                        'class' => 'App\\Entity\\ObservacionesTerritorio',
                        'name' => 'ObservacionesTerritorio',
                    ],
                    'Temporada' => [
                        'class' => 'App\\Entity\\Temporada',
                        'name' => 'Temporada',
                    ],
                    'TipoEdificio' => [
                        'class' => 'App\\Entity\\TipoEdificio',
                        'name' => 'TipoEdificio',
                    ],
                    'TipoPropiedad' => [
                        'class' => 'App\\Entity\\TipoPropiedad',
                        'name' => 'TipoPropiedad',
                    ],
                    'TipoTerritorio' => [
                        'class' => 'App\\Entity\\TipoTerritorio',
                        'name' => 'TipoTerritorio',
                    ],
                ],
                'design' => [
