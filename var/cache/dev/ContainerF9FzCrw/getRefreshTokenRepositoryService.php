...
// Returns the private 'App\Repository\RefreshTokenRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RefreshTokenRepository.php';

return $this->privates['App\\Repository\\RefreshTokenRepository'] = new \App\Repository\RefreshTokenRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
