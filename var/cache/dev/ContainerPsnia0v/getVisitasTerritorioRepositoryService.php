...
// Returns the private 'App\Repository\VisitasTerritorioRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VisitasTerritorioRepository.php';

return $this->services['App\Repository\VisitasTerritorioRepository'] = new \App\Repository\VisitasTerritorioRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
