...
// Returns the private 'App\Repository\ObservacionesTerritorioRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ObservacionesTerritorioRepository.php';

return $this->services['App\Repository\ObservacionesTerritorioRepository'] = new \App\Repository\ObservacionesTerritorioRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
