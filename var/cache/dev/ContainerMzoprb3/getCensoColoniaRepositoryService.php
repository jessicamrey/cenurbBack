...
// Returns the private 'App\Repository\CensoColoniaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CensoColoniaRepository.php';

return $this->services['App\Repository\CensoColoniaRepository'] = new \App\Repository\CensoColoniaRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
