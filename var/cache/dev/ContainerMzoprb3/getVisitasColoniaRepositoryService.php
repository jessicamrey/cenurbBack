...
// Returns the private 'App\Repository\VisitasColoniaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VisitasColoniaRepository.php';

return $this->services['App\Repository\VisitasColoniaRepository'] = new \App\Repository\VisitasColoniaRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
