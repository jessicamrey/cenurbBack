...
class srcDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['api_platform.metadata.extractor.yaml'] = new \ApiPlatform\Core\Metadata\Extractor\YamlExtractor(array(0 => ($this->targetDirs[3].'/config/packages/apiplatform/tempUser.yml'), 1 => ($this->targetDirs[3].'/config/packages/apiplatform/otrasEspecies.yml'), 2 => ($this->targetDirs[3].'/config/packages/apiplatform/locNidosCol.yml'), 3 => ($this->targetDirs[3].'/config/packages/apiplatform/colonia.yml'), 4 => ($this->targetDirs[3].'/config/packages/apiplatform/visitasColonia.yml')));
    }
