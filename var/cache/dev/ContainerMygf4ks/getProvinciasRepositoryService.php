...
// Returns the private 'App\Repository\ProvinciasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProvinciasRepository.php';

return $this->services['App\\Repository\\ProvinciasRepository'] = new \App\Repository\ProvinciasRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
