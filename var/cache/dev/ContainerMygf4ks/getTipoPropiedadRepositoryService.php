...
// Returns the private 'App\Repository\TipoPropiedadRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TipoPropiedadRepository.php';

return $this->services['App\\Repository\\TipoPropiedadRepository'] = new \App\Repository\TipoPropiedadRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
