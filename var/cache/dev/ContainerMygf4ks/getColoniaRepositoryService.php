...
// Returns the private 'App\Repository\ColoniaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ColoniaRepository.php';

return $this->services['App\\Repository\\ColoniaRepository'] = new \App\Repository\ColoniaRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
