...
// Returns the private 'App\Repository\TemporadaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TemporadaRepository.php';

return $this->services['App\\Repository\\TemporadaRepository'] = new \App\Repository\TemporadaRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
