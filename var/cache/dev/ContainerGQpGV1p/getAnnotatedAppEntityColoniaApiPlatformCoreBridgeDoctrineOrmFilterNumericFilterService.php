...
// Returns the private 'annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_numeric_filter' shared autowired service.
...
return $this->privates['annotated_app_entity_colonia_api_platform_core_bridge_doctrine_orm_filter_numeric_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\NumericFilter(($this->services['doctrine'] ?? $this->getDoctrineService()), NULL, ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ['especie' => NULL]);
