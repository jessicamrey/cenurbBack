...
// Returns the private 'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_date_filter' shared autowired service.
...
return $this->privates['annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_date_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\DateFilter(($this->services['doctrine'] ?? $this->getDoctrineService()), NULL, ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ['fecha' => NULL]);
