...
// Returns the private 'App\Repository\SegUsuRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SegUsuRepository.php';

return $this->privates['App\\Repository\\SegUsuRepository'] = new \App\Repository\SegUsuRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
