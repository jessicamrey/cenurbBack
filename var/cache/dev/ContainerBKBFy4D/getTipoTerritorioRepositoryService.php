...
return $this->privates['App\\Repository\\TipoTerritorioRepository'] = new \App\Repository\TipoTerritorioRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
