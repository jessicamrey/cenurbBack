...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_range_filter' => 'getAnnotatedAppEntityVisitasColoniaApiPlatformCoreBridgeDoctrineOrmFilterRangeFilterService.php',
            ...
            'annotated_app_entity_visitas_territorio_api_platform_core_bridge_doctrine_orm_filter_range_filter' => 'getAnnotatedAppEntityVisitasTerritorioApiPlatformCoreBridgeDoctrineOrmFilterRangeFilterService.php',
        ...
        $this->privates = array(
            ...
            'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_range_filter' => true,
            ...
            'annotated_app_entity_visitas_territorio_api_platform_core_bridge_doctrine_orm_filter_range_filter' => true,
    ...
    {
        return $this->services['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\ServiceLocator(array('annotated_app_entity_censo_municipio_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => function () {
        ...
        }, 'annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_range_filter' => function () {
            return ${($_ = isset($this->services['annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_range_filter']) ? $this->services['annotated_app_entity_visitas_colonia_api_platform_core_bridge_doctrine_orm_filter_range_filter'] : $this->load('getAnnotatedAppEntityVisitasColoniaApiPlatformCoreBridgeDoctrineOrmFilterRangeFilterService.php')) && false ?: '_'};
        ...
        }, 'annotated_app_entity_visitas_territorio_api_platform_core_bridge_doctrine_orm_filter_range_filter' => function () {
            return ${($_ = isset($this->services['annotated_app_entity_visitas_territorio_api_platform_core_bridge_doctrine_orm_filter_range_filter']) ? $this->services['annotated_app_entity_visitas_territorio_api_platform_core_bridge_doctrine_orm_filter_range_filter'] : $this->load('getAnnotatedAppEntityVisitasTerritorioApiPlatformCoreBridgeDoctrineOrmFilterRangeFilterService.php')) && false ?: '_'};
    ...
    {
        return $this->services['api_platform.metadata.extractor.yaml'] = new \ApiPlatform\Core\Metadata\Extractor\YamlExtractor(array(0 => ($this->targetDirs[3].'/config/packages/apiplatform/tempUser.yml'), 1 => ($this->targetDirs[3].'/config/packages/apiplatform/locNidosCol.yml'), 2 => ($this->targetDirs[3].'/config/packages/apiplatform/colonia.yml')));
    }
