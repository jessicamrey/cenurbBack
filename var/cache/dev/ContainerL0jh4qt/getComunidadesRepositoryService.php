...
// Returns the private 'App\Repository\ComunidadesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComunidadesRepository.php';

return $this->services['App\Repository\ComunidadesRepository'] = new \App\Repository\ComunidadesRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
