...
return $this->privates['App\\Repository\\CensoMunicipioRepository'] = new \App\Repository\CensoMunicipioRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
